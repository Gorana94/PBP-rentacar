...
insert into Lokacija (sifra_lokacije, telefon, ptt, adresa) values (1, '0696541253', '11000', 'Mihajla Pupina, Beograd'), (2, '0691231253', '32000', 'Vojvode Stepe, cacak'), (3, '0696541963', '36000', 'ibarska 15, Kraljevo');

insert into Vozilo (brRegTablica, model, godina_proizvodnje, boja, kapacitet, tip, cena_po_danu, sifra_lokacije) values 
				('BG125AC','Audi A8',2010 ,'crna',5 , 'Lux', 100.00, 1),
                            ('BG789SR','BMW 7', 2015,'crna', 5, 'Lux', 100.00, 1),
                            ('BG325BG','Mercedes S-Class',2016 ,'bela',5 , 'Lux',100.00 , 1),
                            ('BG456HJ','Buggatti Veyron', 2013,'bela',5 , 'Sportski', 120.00, 1),
                            ('BG236NB','Ferrari', 2010,'crna', 5, 'Sportski', 120.00, 1),
                            ('BG563IU','Hyundai Accent',2014 ,'bela', 5, 'Mini', 65.00, 1),
                            ('BG111KH','Ford Fiesta',2010 ,'crna', 5, 'Mini', 65.00, 1),
                            ('BG222KK','Opel Corsa',2010 ,'bela', 5, 'Mini',65.00,1 ),
                            ('BG444LO','Suzuki Swift',2010 ,'siva', 5, 'Mini', 65.00, 1),
                            ('BG693LK','Ford Mondeo',2010 ,'siva', 5, 'Porodicni', 55.00 , 1),
                            ('BG756KJ','Opel Vectra', 2014,'siva', 5, 'Porodicni',55.00 , 1),
                            ('BG452MN','Toyota Camry',2014 ,'siva', 5, 'Porodicni',55.00 , 1),
                            ('BG230JK','VWPassat', 2014,'siva',5 , 'Porodicni', 55.00,1 ),
                            ('BG789YU','Renault',2014 ,'siva', 5, 'Gradski',45.00 , 1),
                            ('BG326HJ','Toyota Aygo',2014 ,'siva',5 , 'Gradski', 45.00 , 1),
                            ('BG369TY','VW Lupo',2014 ,'crna',5 , 'Gradski', 45.00 , 1),
                            ('BG232OP','Ford F-150',2014 ,'crna', 5, 'pick-up', 45.00 , 1),
                            ('BG330HJ','Mitsubishi Triton',2014 ,'crna',5 , 'pick-up', 45.00 , 1),
                            ('BG987KL','Nissan Navara', 2014,'crna', 5, 'pick-up', 45.00 ,1 ),
                            ('BG758YU','Ford Focus',2014 ,'crna',5 , 'Mali porodicni', 45.00 ,1 ),                            
                            ('BG125AV','Audi A8',2010 ,'crna',5 , 'Lux', 100.00, 2),
                            ('BG789PP','BMW 7', 2015,'crna', 5, 'Lux', 100.00, 2),
                            ('BG324GG','Mercedes S-Class',2016 ,'bela',5 , 'Lux',100.00 , 2),
                            ('BG456JJ','Buggatti Veyron', 2013,'bela',5 , 'Sportski', 120.00, 2),
                            ('BG236LD','Ferrari', 2010,'crna', 5, 'Sportski', 120.00, 2),
                            ('BG563PO','Hyundai Accent',2014 ,'bela', 5, 'Mini', 65.00, 2),
                            ('BG111LO','Ford Fiesta',2010 ,'crna', 5, 'Mini', 65.00, 2),
                            ('BG222IK','Opel Corsa',2010 ,'bela', 5, 'Mini',65.00,2),
                            ('BG444MM','Suzuki Swift',2010 ,'siva', 5, 'Mini', 65.00, 2),
                            ('BG693TT','Ford Mondeo',2010 ,'siva', 5, 'Porodicni', 55.00 , 2),
                            ('BG756FF','Opel Vectra', 2014,'siva', 5, 'Porodicni',55.00 , 2),
                            ('BG452GY','Toyota Camry',2014 ,'siva', 5, 'Porodicni',55.00 , 3),
                            ('BG230RG','VWPassat', 2014,'siva',5 , 'Porodicni', 55.00,3 ),
                            ('BG789WE','Renault',2014 ,'siva', 5, 'Gradski',45.00 , 3),
                            ('BG326FG','Toyota Aygo',2014 ,'siva',5 , 'Gradski', 45.00 , 3),
                            ('BG369YU','VW Lupo',2014 ,'crna',5 , 'Gradski', 45.00 , 3),
                            ('BG232SS','Ford F-150',2014 ,'crna', 5, 'pick-up', 45.00 , 3),
                            ('BG330VB','Mitsubishi Triton',2014 ,'crna',5 , 'pick-up', 45.00 , 3),
                            ('BG987UI','Nissan Navara', 2014,'crna', 5, 'pick-up', 45.00 ,3 ),
                            ('BG758SS','Ford Focus',2014 ,'crna',5 , 'Mali porodicni', 45.00 ,3 );
                            
insert into Osiguranje (sifra_osiguranja, pokrice_korisnika, pokrice_sl_stete, tip) values (1, 50000.00, 50000.00, 'CDW'), (2, 100000.00, 100000.00, 'SCDW'),
				(3, 100000.00, 100000.00, 'CCI'), (4, 100000.00, 100000.00, 'ZIM');
    
insert into Nacin_Placanja (sifra_nacina_placanja, metod, opis) values 
				(1, 'novac', ''),
                            (2, 'novac', ''),
                            (3, 'novac', ''),
                            (4, 'novac', ''),
                            (5, 'novac', ''),
                            (6, 'kartica', '1458547812563698'),
                            (7, 'kartica', '1458547852563698'),
                            (8, 'kartica', '8896547812563698'),
                            (9, 'novac', ''),
                            (10, 'kratica', '1458547812211698'),
                            (11, 'kartica', '1458547812566633'),
                            (12, 'novac', ''),
                            (13, 'novac', ''),
                            (14, 'novac', ''),
                            (15, 'novac', ''),
                            (16, 'novac', ''),
                            (17, 'kartica', '1458547812563456'),
                            (18, 'kartica', '1458512362563698'),
                            (19, 'kartica', '1458547878523698'),
                            (20, 'novac', '');


insert into Placanje (sifra_placanja, sifra_nacina_placanja) values
				(1,1),
                            (2,2),
                            (3,3),
                            (4,4),
...
insert into Rentira (sifra_korisnika, brRegTablica, datum_pocetka, datum_kraja,ukupna_cena,  sifra_placanja) values
				(1, 'BG125AC', '2017-01-01','2017-01-07',0.00, 1 ),
                            (2, 'BG789SR', '2017-01-07','2017-01-20',0.00, 2),
                            (3, 'BG325BG', '2017-02-20','2017-02-27',0.00, 3),
                            (4, 'BG326HJ', '2017-04-25','2017-04-27',0.00, 4),
                            (5, 'BG987KL', '2017-04-25','2017-05-12',0.00, 5),
                            (6, 'BG758YU', '2017-04-26','2017-04-28',0.00, 6),
                            (7, 'BG125AV', '2017-04-12','2017-04-30', 0.00,7),
                            (8, 'BG111LO', '2017-05-12','2017-05-30',0.00, 8),
                            (9, 'BG222IK', '2017-05-13','2017-06-30',0.00, 9),
                            (10, 'BG444MM', '2017-05-23','2017-06-30',0.00,10 ),
                            (21, 'BG230RG', '2017-05-14','2017-06-30',0.00, 11),
                            (22, 'BG326FG', '2017-06-12','2017-06-14',0.00, 12),
                            (23, 'BG369YU', '2017-06-13','2017-06-30', 0.00,13),
                            (24, 'BG232SS', '2017-06-23','2017-07-12',0.00, 14),
                            (25, 'BG987UI', '2017-06-23','2017-07-13',0.00, 15),
                            (26, 'BG758SS', '2017-07-14','2017-07-30',0.00, 16),
                            (27, 'BG444LO', '2017-07-12','2017-08-10',0.00, 17),
                            (28, 'BG693LK', '2017-07-30','2017-08-30',0.00, 18),
                            (29, 'BG330HJ', '2017-08-12','2017-09-10',0.00, 19),
                            (30, 'BG230JK', '2017-08-14','2017-08-25',0.00, 20);
...
insert into Rentiranje_opreme (sifra_korisnika, brRegTablica, sifra_opreme) values
				(1, 'BG125AC', 1),
                            (1, 'BG125AC', 3),
                            (1, 'BG125AC', 2),
                            (2, 'BG789SR',1),
...
insert into Poseduje_Osiguranje (brRegTablica, sifra_osiguranja, cena, sifra_korisnika) values
				('BG125AC',1, 10.00 ,1 ),
                            ('BG125AC',2, 15.00 ,1 ),
                            ('BG789SR',1 ,10.00, 2),
                            ('BG325BG',2,15.00, 3),
